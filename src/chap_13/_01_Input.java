...
public class _01_Input {
    public static void main(String[] args) {
        // 사용자 입력
        // scanner는 기본 형이 String 이므로 숫자나 실수 입력시 단순히 sc.next가 아닌, Integer.parseInt(sc.next()); , Double.parseDouble(sc.next()); 로 해야 한다
        // sc.next(): 한 단어 ex) 예를 들어 자바 재미있어요 라고 입력시, 자바만이 sc가 담고 나머지 재미있어요는 다음 sc로 넘어가게 됨
        // sc.nextLine(): 한 문장 ex) 자바 재미있어요를 다 출력하게 됨
